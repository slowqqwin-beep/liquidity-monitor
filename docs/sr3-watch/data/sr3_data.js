window.SR3_DATA = {
  ...
  "current": {
    ...
    "curve_move_5d_sum_bp": -2.12,
    "decline_from_ref_peak_bp": -12.04,
  ...
  "deceleration": true,
  "level_repair": false,
  "classification": "structural_easing_confirming",
  "classification_reason": "全线合约低于参考峰(2026-06-22)，且 5d累计转负(-2.1bp) — 结构松动获得动能确认",
  "near_rate": 3.885,
  "daily_change_bp": 5.88,
  "five_day_change_bp": -2.12,
  "high_plateau": true,
  "hy_oas": 283.0,
  "reference_peaks": [
    {
  ...
  "hike_over_repair_magnitude_bp": 14.67,
  "hike_over_repair_ratio": 0.607,
  "hike_over_remaining_bp": 9.5,
  ...
  "current_event_note": "本轮不是简单 price-out 降息，而是 FOMC/沃什后曲线 price-over / hike-over。事件前基准 2026-06-16，hike-over 峰值 2026-06-22，冲击约 +24.2bp；当前已修复约 14.7bp（60.7%），距离事件前基准仍约 +9.5bp。当前事件修复启动不等于 level repair，也不是买入信号。",
  "current_event_repair_magnitude_bp": 14.67,
  "current_event_drawdown_from_peak_bp": -14.67,
  ...
  "two3m_latest": {
    ...
    "structure": "Stable / 稳定",
    "structure_note": "2s10s 日度变化较小，曲线结构暂未给出强确认。",
    "latest_date": "2026-06-29",
    "has_yields": false,
    "d3m_1d_bp": 2.0
  },
